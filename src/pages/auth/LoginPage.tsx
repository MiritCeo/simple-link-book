...
export default function LoginPage() {
  ...
  return (
    <AuthSplitLayout
      eyebrow="Panel salonu"
      title="Prowadzisz salon? Wszystko masz w jednym miejscu."
      subtitle="Kalendarz, klienci, usługi i powiadomienia — bez przełączania między narzędziami."
      points={[
        'Szybki podgląd dnia i wolnych terminów',
        'Wiadomości SMS i e-mail do klientów',
        'Wygodna obsługa usług, zespołu i ustawień salonu',
      ]}
    >
